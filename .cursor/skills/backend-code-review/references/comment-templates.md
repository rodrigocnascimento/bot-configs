...
> Inicie cada descrição se referindo ao usuário como **"Developer"**.
...
Developer, a lógica implementada não cobre corretamente o cenário esperado.
...
Developer, esta implementação pode introduzir uma vulnerabilidade.
...
Developer, este fluxo executa múltiplas operações no banco sem transação.
...
Developer, esta lógica está sendo executada em uma camada incorreta.
...
Developer, este filtro está sendo aplicado após carregar os dados do banco.
...
Developer, esta chamada assíncrona pode falhar e não possui tratamento de erro.
...
Developer, este módulo contém lógica de negócio relevante e não possui testes unitários.
...
Developer, esta implementação pode gerar múltiplas queries ao acessar relações.
...
Developer, esta implementação pode ser simplificada para melhorar legibilidade e manutenção.
